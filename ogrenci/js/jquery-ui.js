...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran",
			"Temuz","Ağustos ","Eylül","Ekim","Kasım","Aralık"], // Names of months for drop-down and formatting
		monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], // For formatting
		dayNames: ["Pazar","Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma","Cumartesi"], // For formatting
		
		dayNamesMin: ["pzr","Pts","Sal","Çrş","Prş","cum","cts",], // Column headings for days starting at Sunday
		weekHeader: "dd", // Column header for week of the year
		dateFormat: "dd.mm.yy", // See format options on parseDate
		firstDay:Mon=1,   // The first day of the week, Sun = 0, Mon = 1, ...
